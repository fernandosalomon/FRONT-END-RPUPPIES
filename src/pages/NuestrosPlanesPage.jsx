...
import "../css/NuestrosPlanesPage.css"
import { useForm } from "react-hook-form";
import {z} from "zod"
import { zodResolver } from "@hookform/resolvers/zod";

const NuestrosPlanesPage = () => {

    const contactSchema = z.object({
        nombre: z.string({message: "Formato incorrecto"}).min(1, {message: "Campo requerido"}).max(25, {message: "Máximo permitido: 25 caracteres"}),
        apellido: z.string({message: "Formato incorrecto"}).min(1, {message: "Campo requerido"}).max(25, {message: "Máximo permitido: 25 caracteres"}),
        email: z.string({message: "Formato incorrecto"}).min(1, {message: "Campo requerido"}).email({message: "Formato de email incorrecto (Ej.: to@email.com)"}),
        plan: z.enum(["primeros-pasos", "madurando", "adultos"], {message: "Elije uno de los planes"}),
        mensaje: z.string({message: "Formato incorrecto"}).max(250, {message: "Máximo permitido: 250 caracteres"})
    })
    ...
    return (
        <>
        <Container fluid className="py-3 bgColorFondo nuestros-planes-page--wrapper">
            <h2 className="planes-page-title">Planes de seguro personalizados para tus mascotas</h2>
            <h3 className="planes-page-subtitle">Actualmente contamos con los siguientes planes de seguro para tus mascotas. Para que uno de nuestros profecionales se ponga en contacto contigo rellena el formulario más abajo.</h3>
            <Accordion>
                <Accordion.Item eventKey="0" className="bgColorFondo">
                    <Accordion.Header >
                ...
                <Accordion.Item eventKey="1" className="bgColorFondo">
                <Accordion.Header >
                        <div className="d-flex align-items-center justify-content-between w-100">
                ...
                <Accordion.Item eventKey="2" className="bgColorFondo">
                <Accordion.Header >
                        <div className="d-flex align-items-center justify-content-between w-100">
        ...
        <Container className="my-5 contact-form--wrapper">
...
export default NuestrosPlanesPage;
