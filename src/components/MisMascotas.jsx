        ...
        <div className={styleMisMascotas.cardMascota} data-aos="zoom-in">
            <div className={styleMisMascotas.cardContenido}>
                ...
                <div className={styleMisMascotas.imgPet}>
                    <img className={styleMisMascotas.imgMascota} src={imgPerro1} alt="perro"/>
                </div>
                ...
                <div className={styleMisMascotas.botonesMascotas}>
                    ...
                    <ModalEditarMascota show={showModalEditarMascota} handleClose={handleCloseModaEditarrMascota} mascota={mascota}/>
                </div>
            </div>
    ...
    return (
        <div className={styleMisMascotas.cardMascota} data-aos="zoom-in">
            <div className={styleMisMascotas.cardContenido}>
                ...
                <div className={styleMisMascotas.imgPet}>
                    <img className={styleMisMascotas.imgMascota} src={imgGato2} alt="gato"/>
                </div>
                <h4>{mascota.nombre}</h4>
                <div className={styleMisMascotas.botonesMascotas}>
                    <button className={styleMisMascotas.btnTurno}>
    ...
    return (
        <div className={styleMisMascotas.cardMascota} data-aos="zoom-in">
            <div className={styleMisMascotas.cardContenido}>
                ...
                <div className={styleMisMascotas.imgPet}>
                    <img className={styleMisMascotas.imgMascota} src={imgOtro} alt="gato"/>
                </div>
                <h4>{mascota.nombre}</h4>
                <div className={styleMisMascotas.botonesMascotas}>
                    <button className={styleMisMascotas.btnTurno}>
