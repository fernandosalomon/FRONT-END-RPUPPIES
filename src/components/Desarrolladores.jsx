        ...
        <article className={styleDesarrolladores.cardDesarrolador}>
            <div className={styleDesarrolladores.headCardDesarrolador}>
                ...
                <div className={styleDesarrolladores.contenedorImg}>
                    <img className={styleDesarrolladores.imgDesarrollador} src={props.img} alt={props.nombre}/>
                </div>
            </div>
            <div className={styleDesarrolladores.descripcionDev}>
                <h3>{props.nombre}</h3>
                <h4>{props.puesto}</h4>
                <p><i className="fa-solid fa-screwdriver-wrench"></i> Herramientas: {props.descripcion}
                </p>
            </div>
            <div className={styleDesarrolladores.redesDev}>
                <a className={styleDesarrolladores.linkDev} href={props.linkedin} target="_blank"><i className="fa-brands fa-linkedin"></i></a>
                <a className={styleDesarrolladores.linkDev} href={props.github} target="_blank"><i className="fa-brands fa-github"></i></a>
                <a className={styleDesarrolladores.linkDev} href={props.porfolio} target="_blank"><i className="fa-solid fa-briefcase"></i></a>
            </div>
        </article>
    );
}
